...
export default function AcoesCiveisGeral() {
  ...
  const rules = useMemo<CustasItemRule[]>(() => parametros.custas?.regras.acoesCiveis ?? [], [parametros])
  ...
  const onCalculate = () => {
    ...
    const idsIsentos = parametros.custas?.gratuidade.isentos.acoesCiveis ?? []
